class CatModel {
  ...
  factory CatModel.fromJson(Map<String, dynamic> json) => CatModel(
        ...
        cfaUrl: json["cfa_url"] ?? 'No cfaurl',
        vetstreetUrl: json["vetstreet_url"] ?? 'No vetstreet',
        vcahospitalsUrl: json["vcahospitals_url"] ?? 'No vcahospitals',
        temperament: json["temperament"] ?? 'No temperament',
        origin: json["origin"] ?? 'No origin',
        countryCodes: json["country_codes"] ?? 'No country',
        countryCode: json["country_code"] ?? 'No country code',
        description: json["description"] ?? 'No description',
        lifeSpan: json["life_span"] ?? 'No life span',
        indoor: json["indoor"] ?? 0,
        lap: json["lap"] ?? 0,
        altNames: json["alt_names"] ?? 'No alternatives names',
        ...
        wikipediaUrl: json["wikipedia_url"] ?? 'No wiki entry',
        hypoallergenic: json["hypoallergenic"] ?? 0,
        referenceImageId: json["reference_image_id"] ?? 'No ref image',
      );
